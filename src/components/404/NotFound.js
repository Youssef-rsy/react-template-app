            ...
            <div className="content-wrapper  m-0" >
                <div className=" container-fluid vh-100 d-flex justify-content-center" style={backgroundStyle1}>
                    <div className="row w-75 d-flex justify-content-center align-self-center   d-flex flex-row " >
                        <img src={_404_} alt="Page Note Found" className="card-img-top w-50 col-12 col-lg-8" />
                        <div className="card col-12 col-lg-4 my-0">
                            <div className="card-body d-flex flex-column justify-content-around" >
                                <h4 className="card-title text-center text-justify">{t('notFound.title')}</h4>
                                <p className="card-text text-center">{t('notFound.description')} </p>
